# Use Cases و User Stories - مشروع الزيتون سوفت

## مقدمة
يحتوي هذا الملف على جميع السيناريوهات الوظيفية (Use Cases) والقصص المستخدمة (User Stories) التي تحدد ما يمكن للمستخدمين فعله داخل نظام الزيتون سوفت. تم تنظيمها حسب الشخصيات المختلفة مع التركيز على الوظائف الأساسية والمتقدمة.
