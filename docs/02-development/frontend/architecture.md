...
يُبنى الفرونت إند لتطبيق الزيتون سوفت SaaS باستخدام **React 18+ مع TypeScript** ويتبع معمارية حديثة وقابلة للتوسع. التطبيق مصمم ليكون Progressive Web App (PWA) مع دعم كامل للعمل بدون إنترنت والمزامنة التلقائية.
