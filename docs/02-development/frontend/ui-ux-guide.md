...
هذا الدليل يحدد معايير التصميم والتجربة المستخدمة في تطبيق الزيتون سوفت SaaS. يهدف إلى ضمان تجربة مستخدم متسقة وحديثة عبر جميع صفحات التطبيق.
...
```typescript
// Primary Color - الزيتون سوفت (أخضر)
primary: {
