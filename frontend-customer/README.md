# Frontend Customer - Zaytun Soft SaaS

لوحة تحكم الزيتون سوفت SaaS - واجهة العملاء (التجار)

## نظرة عامة

تطبيق React + TypeScript لبناء واجهة إدارية شاملة للعملاء في نظام الزيتون سوفت SaaS، يتضمن:
