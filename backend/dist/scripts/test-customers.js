...
async function testCustomerSystem() {
    ...
    try {
        ...
        const invoiceResponse = await (0, supertest_1.default)(server)
            ...
            lines: [
                {
                    productVariantId: 'some-variant-id',
                    quantity: 2,
                    unitPrice: 299.99,
        ...
        const loyaltyResponse = await (0, supertest_1.default)(server)
        ...
        console.log('\n⭐ تحديث نقاط الولاء...');
        const updatePointsResponse = await (0, supertest_1.default)(server)
        ...
        const updateCustomerResponse = await (0, supertest_1.default)(server)
        ...
        const advancedSearchResponse = await (0, supertest_1.default)(server)
        ...
        const getCustomerResponse = await (0, supertest_1.default)(server)
        ...
        const deleteResponse = await (0, supertest_1.default)(server)
...
testCustomerSystem();
//# sourceMappingURL=test-customers.js.map